package com.blauwmaan.webflux.springwebflux.controllers;
...
class CategoryControllerTest {
    ...
    void list() {
        BDDMockito.given(categoryRepository.findAll())
                .willReturn(Flux.just(Category.builder().description("CatOne").build(),
                        Category.builder().description("CatTwo").build()));
